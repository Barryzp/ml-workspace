...
rel_path = "D:workspace/ml-workspace/registration/implement/cec2013/extdata"
...
class CEC_functions:
    def __init__(self , dim):
        ...
        csv_file = open(f'{current_dir}/extdata/M_D' + str(dim) + '.txt')
        ...
        csv_file = open(f'{current_dir}/extdata/shift_data.txt')
        csv_data = csv.reader(csv_file, delimiter=' ')
        self.sd = []
        for row in csv_data:
